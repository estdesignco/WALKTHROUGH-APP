...
async def test_catalog_api():
    ...
    base_url = "https://apprescue-deploy.preview.emergentagent.com/api/furniture"
...
async def main():
    ...
    if count > 0:
        ...
        print(f"\n🔗 NEXT STEPS:")
        print(f"1. Refresh: https://apprescue-deploy.preview.emergentagent.com/furniture-search")
