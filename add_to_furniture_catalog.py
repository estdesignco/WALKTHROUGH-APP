...
async def test_catalog_api():
    ...
    base_url = "https://estdesign-portal.preview.emergentagent.com/api/furniture"
...
async def main():
    ...
    if count > 0:
        ...
        print(f"\n🔗 NEXT STEPS:")
        print(f"1. Refresh: https://estdesign-portal.preview.emergentagent.com/furniture-search")
