...
async def test_catalog_api():
    ...
    base_url = "https://app-stability-fix-4.preview.emergentagent.com/api/furniture"
...
async def main():
    ...
    if count > 0:
        ...
        print(f"\n🔗 NEXT STEPS:")
        print(f"1. Refresh: https://app-stability-fix-4.preview.emergentagent.com/furniture-search")
