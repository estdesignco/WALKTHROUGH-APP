...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://decoresync.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://decoresync.preview.emergentagent.com" in log_output:
