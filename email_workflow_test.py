...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://procuretrack-4.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://procuretrack-4.preview.emergentagent.com" in log_output:
