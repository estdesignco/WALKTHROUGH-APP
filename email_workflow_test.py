...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://bugbuster-77.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://bugbuster-77.preview.emergentagent.com" in log_output:
