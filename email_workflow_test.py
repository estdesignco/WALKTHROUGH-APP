...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://stability-first-2.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://stability-first-2.preview.emergentagent.com" in log_output:
