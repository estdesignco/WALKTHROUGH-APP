...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://designer-scraper.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://designer-scraper.preview.emergentagent.com" in log_output:
