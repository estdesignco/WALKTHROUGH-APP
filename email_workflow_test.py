...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://pricelistmaster.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://pricelistmaster.preview.emergentagent.com" in log_output:
