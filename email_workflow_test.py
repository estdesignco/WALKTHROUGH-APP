...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://vendor-import.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://vendor-import.preview.emergentagent.com" in log_output:
