...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://designerai.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://designerai.preview.emergentagent.com" in log_output:
