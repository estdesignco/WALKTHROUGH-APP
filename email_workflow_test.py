...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://design-preview-131.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://design-preview-131.preview.emergentagent.com" in log_output:
