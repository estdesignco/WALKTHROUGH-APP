...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://dashmaster-15.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://dashmaster-15.preview.emergentagent.com" in log_output:
