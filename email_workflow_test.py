...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://design-hub-120.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://design-hub-120.preview.emergentagent.com" in log_output:
