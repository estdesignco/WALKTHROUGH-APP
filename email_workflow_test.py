...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://devdoctors.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://devdoctors.preview.emergentagent.com" in log_output:
