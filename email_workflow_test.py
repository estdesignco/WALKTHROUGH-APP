...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://designer-hub-45.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://designer-hub-45.preview.emergentagent.com" in log_output:
