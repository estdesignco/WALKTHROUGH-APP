...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://fixmyapp-13.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://fixmyapp-13.preview.emergentagent.com" in log_output:
