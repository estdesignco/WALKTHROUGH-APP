...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://add-room-debug.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://add-room-debug.preview.emergentagent.com" in log_output:
