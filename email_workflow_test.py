...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://interiordata.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://interiordata.preview.emergentagent.com" in log_output:
