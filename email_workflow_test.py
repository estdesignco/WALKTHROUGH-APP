...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://app-stability-fix-4.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://app-stability-fix-4.preview.emergentagent.com" in log_output:
