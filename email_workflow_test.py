...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://clipboard-tool.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://clipboard-tool.preview.emergentagent.com" in log_output:
