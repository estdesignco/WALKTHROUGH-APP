...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://bugsquash-hub.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://bugsquash-hub.preview.emergentagent.com" in log_output:
