...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://bugfix-central-89.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://bugfix-central-89.preview.emergentagent.com" in log_output:
