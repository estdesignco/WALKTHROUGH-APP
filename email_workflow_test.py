...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://scrapefixer.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://scrapefixer.preview.emergentagent.com" in log_output:
