...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://furnscape.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://furnscape.preview.emergentagent.com" in log_output:
