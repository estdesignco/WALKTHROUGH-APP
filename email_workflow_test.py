...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://decor-grab.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://decor-grab.preview.emergentagent.com" in log_output:
