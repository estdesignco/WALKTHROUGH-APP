...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://intake-flow-3.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://intake-flow-3.preview.emergentagent.com" in log_output:
