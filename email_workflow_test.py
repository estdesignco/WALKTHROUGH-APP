...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://product-search-hub-1.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://product-search-hub-1.preview.emergentagent.com" in log_output:
