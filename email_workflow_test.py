...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://interiortools-1.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://interiortools-1.preview.emergentagent.com" in log_output:
