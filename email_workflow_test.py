...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://edit-scraped-data.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://edit-scraped-data.preview.emergentagent.com" in log_output:
