...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://designflow-hub-1.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://designflow-hub-1.preview.emergentagent.com" in log_output:
