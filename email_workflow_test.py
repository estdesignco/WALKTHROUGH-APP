...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://catalog-mirror.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://catalog-mirror.preview.emergentagent.com" in log_output:
