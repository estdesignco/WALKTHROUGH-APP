...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://interioreye-app.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://interioreye-app.preview.emergentagent.com" in log_output:
