...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://productfinder-8.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://productfinder-8.preview.emergentagent.com" in log_output:
