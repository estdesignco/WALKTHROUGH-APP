...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://fixr-design-app.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://fixr-design-app.preview.emergentagent.com" in log_output:
