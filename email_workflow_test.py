...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://design-sourcer.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://design-sourcer.preview.emergentagent.com" in log_output:
