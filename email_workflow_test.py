...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://projectease-5.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://projectease-5.preview.emergentagent.com" in log_output:
