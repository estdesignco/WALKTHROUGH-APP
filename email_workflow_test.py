...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://data-prefill.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://data-prefill.preview.emergentagent.com" in log_output:
