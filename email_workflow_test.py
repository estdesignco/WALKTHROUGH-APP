...
def test_send_questionnaire_email():
    ...
    try:
        ...
        print(f"   Expected URL pattern: https://preview-debug-14.preview.emergentagent.com/customer/questionnaire")
        ...
        try:
            ...
            if "https://preview-debug-14.preview.emergentagent.com" in log_output:
