  ...
  sidePanel.innerHTML = `
    ...
    <div class="dr-content" id="dr-content">
      ...
      <div class="dr-field" data-field="price">
        ...
        <input class="dr-field-input" id="dr-field-price" type="text" placeholder="Not found" />
      </div>
      ...
      <div class="dr-field" data-field="image_url">
        ...
        <input class="dr-field-input" id="dr-field-image_url" type="text" placeholder="Not found" />
      </div>
