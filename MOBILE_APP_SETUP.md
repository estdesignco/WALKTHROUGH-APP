...
Edit `/app/mobile/.env`:
```env
BACKEND_URL=https://decoresync.preview.emergentagent.com
API_URL=https://decoresync.preview.emergentagent.com/api
```
...
- Test endpoint: `curl https://decoresync.preview.emergentagent.com/api/projects`
