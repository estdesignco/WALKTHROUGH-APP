...
Edit `/app/mobile/.env`:
```env
BACKEND_URL=https://design-burst.preview.emergentagent.com
API_URL=https://design-burst.preview.emergentagent.com/api
```
...
- Test endpoint: `curl https://design-burst.preview.emergentagent.com/api/projects`
