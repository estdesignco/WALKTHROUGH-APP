...
Edit `/app/mobile/.env`:
```env
BACKEND_URL=https://designerai.preview.emergentagent.com
API_URL=https://designerai.preview.emergentagent.com/api
```
...
- Test endpoint: `curl https://designerai.preview.emergentagent.com/api/projects`
