...
Edit `/app/mobile/.env`:
```env
BACKEND_URL=https://design-preview-131.preview.emergentagent.com
API_URL=https://design-preview-131.preview.emergentagent.com/api
```
...
- Test endpoint: `curl https://design-preview-131.preview.emergentagent.com/api/projects`
