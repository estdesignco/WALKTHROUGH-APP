...
Edit `/app/mobile/.env`:
```env
BACKEND_URL=https://vendor-import.preview.emergentagent.com
API_URL=https://vendor-import.preview.emergentagent.com/api
```
...
- Test endpoint: `curl https://vendor-import.preview.emergentagent.com/api/projects`
