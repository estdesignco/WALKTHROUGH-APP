...
Edit `/app/mobile/.env`:
```env
BACKEND_URL=https://designmate-3.preview.emergentagent.com
API_URL=https://designmate-3.preview.emergentagent.com/api
```
...
- Test endpoint: `curl https://designmate-3.preview.emergentagent.com/api/projects`
