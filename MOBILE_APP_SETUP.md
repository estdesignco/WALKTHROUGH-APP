...
Edit `/app/mobile/.env`:
```env
BACKEND_URL=https://intake-flow-3.preview.emergentagent.com
API_URL=https://intake-flow-3.preview.emergentagent.com/api
```
...
- Test endpoint: `curl https://intake-flow-3.preview.emergentagent.com/api/projects`
