...
Edit `/app/mobile/.env`:
```env
BACKEND_URL=https://clipboard-tool.preview.emergentagent.com
API_URL=https://clipboard-tool.preview.emergentagent.com/api
```
...
- Test endpoint: `curl https://clipboard-tool.preview.emergentagent.com/api/projects`
