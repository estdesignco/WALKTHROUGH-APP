...
Edit `/app/mobile/.env`:
```env
BACKEND_URL=https://designflow-hub.preview.emergentagent.com
API_URL=https://designflow-hub.preview.emergentagent.com/api
```
...
- Test endpoint: `curl https://designflow-hub.preview.emergentagent.com/api/projects`
