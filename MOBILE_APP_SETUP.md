...
Edit `/app/mobile/.env`:
```env
BACKEND_URL=https://spacemaster-1.preview.emergentagent.com
API_URL=https://spacemaster-1.preview.emergentagent.com/api
```
...
- Test endpoint: `curl https://spacemaster-1.preview.emergentagent.com/api/projects`
