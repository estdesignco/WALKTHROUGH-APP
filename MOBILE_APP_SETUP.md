...
Edit `/app/mobile/.env`:
```env
BACKEND_URL=https://design-hub-120.preview.emergentagent.com
API_URL=https://design-hub-120.preview.emergentagent.com/api
```
...
- Test endpoint: `curl https://design-hub-120.preview.emergentagent.com/api/projects`
