...
Edit `/app/mobile/.env`:
```env
BACKEND_URL=https://projectease-5.preview.emergentagent.com
API_URL=https://projectease-5.preview.emergentagent.com/api
```
...
- Test endpoint: `curl https://projectease-5.preview.emergentagent.com/api/projects`
