...
Edit `/app/mobile/.env`:
```env
BACKEND_URL=https://material-mapper-1.preview.emergentagent.com
API_URL=https://material-mapper-1.preview.emergentagent.com/api
```
...
- Test endpoint: `curl https://material-mapper-1.preview.emergentagent.com/api/projects`
