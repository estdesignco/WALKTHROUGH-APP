...
Edit `/app/mobile/.env`:
```env
BACKEND_URL=https://designflow-59.preview.emergentagent.com
API_URL=https://designflow-59.preview.emergentagent.com/api
```
...
- Test endpoint: `curl https://designflow-59.preview.emergentagent.com/api/projects`
