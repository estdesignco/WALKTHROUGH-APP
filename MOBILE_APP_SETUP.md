...
Edit `/app/mobile/.env`:
```env
BACKEND_URL=https://design-sourcer.preview.emergentagent.com
API_URL=https://design-sourcer.preview.emergentagent.com/api
```
...
- Test endpoint: `curl https://design-sourcer.preview.emergentagent.com/api/projects`
