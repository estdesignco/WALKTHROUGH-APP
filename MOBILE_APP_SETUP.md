...
Edit `/app/mobile/.env`:
```env
BACKEND_URL=https://interioriq-2.preview.emergentagent.com
API_URL=https://interioriq-2.preview.emergentagent.com/api
```
...
- Test endpoint: `curl https://interioriq-2.preview.emergentagent.com/api/projects`
