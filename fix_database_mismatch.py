...
async def test_api_after_fix():
    ...
    base_url = "https://design-import-tool-1.preview.emergentagent.com/api"
...
async def main():
    ...
    if count > 0:
        ...
        print(f"\n🔗 NEXT STEPS:")
        print(f"1. Refresh: https://design-import-tool-1.preview.emergentagent.com/furniture-search")
