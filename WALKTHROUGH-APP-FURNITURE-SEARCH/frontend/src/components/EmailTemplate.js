...
const EmailTemplate = ({ clientName, questionnaireLinkId }) => {
    const questionnaireUrl = `${process.env.REACT_APP_FRONTEND_URL || 'https://app-stability-fix-4.preview.emergentagent.com'}/customer/questionnaire/${questionnaireLinkId}`;
