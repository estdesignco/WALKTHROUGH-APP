...
def test_send_questionnaire():
    ...
    print("Expected URL: https://app-stability-fix-4.preview.emergentagent.com/customer/questionnaire")
...
def check_backend_logs():
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            if "https://app-stability-fix-4.preview.emergentagent.com/customer/questionnaire" in logs:
...
if __name__ == "__main__":
    ...
    if test_result and log_result:
        ...
        print("   ✓ URL: https://app-stability-fix-4.preview.emergentagent.com/customer/questionnaire")
