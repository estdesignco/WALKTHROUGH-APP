...
def test_send_questionnaire():
    ...
    print("Expected URL: https://stability-first-2.preview.emergentagent.com/customer/questionnaire")
...
def check_backend_logs():
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            if "https://stability-first-2.preview.emergentagent.com/customer/questionnaire" in logs:
...
if __name__ == "__main__":
    ...
    if test_result and log_result:
        ...
        print("   ✓ URL: https://stability-first-2.preview.emergentagent.com/customer/questionnaire")
