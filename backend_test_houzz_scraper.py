...
class HouzzProScraperTester:
    def __init__(self, base_url="https://app-stability-fix-4.preview.emergentagent.com"):
...
def main():
    ...
    print("="*80)
    print(f"Testing against: https://app-stability-fix-4.preview.emergentagent.com")
