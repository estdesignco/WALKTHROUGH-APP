...
class HouzzProScraperTester:
    def __init__(self, base_url="https://product-search-hub-1.preview.emergentagent.com"):
...
def main():
    ...
    print("="*80)
    print(f"Testing against: https://product-search-hub-1.preview.emergentagent.com")
