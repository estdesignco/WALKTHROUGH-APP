...
class HouzzProScraperTester:
    def __init__(self, base_url="https://design-import-tool-1.preview.emergentagent.com"):
...
def main():
    ...
    print("="*80)
    print(f"Testing against: https://design-import-tool-1.preview.emergentagent.com")
