...
class HouzzProScraperTester:
    def __init__(self, base_url="https://interior-checklist.preview.emergentagent.com"):
...
def main():
    ...
    print("="*80)
    print(f"Testing against: https://interior-checklist.preview.emergentagent.com")
