...
```
https://data-prefill.preview.emergentagent.com/INTERIOR-DESIGN-HUB-V3-COMPLETE-FIXED.zip
```
...
1. **Open Canva Live Checklist:**
   ...
   - Or open directly: `https://data-prefill.preview.emergentagent.com/canva-STAYS-LOADED.js?projectId=YOUR_ID`
...
**Chrome Extension:**
```
https://data-prefill.preview.emergentagent.com/canva-scanner-TRADE-SMART.zip
```

**Canva App (FIXED):**
```
https://data-prefill.preview.emergentagent.com/canva-STAYS-LOADED.js
```

**Scanner Guide:**
```
https://data-prefill.preview.emergentagent.com/canva-scanner-guide.html
```

**Keyboard Shortcuts:**
```
https://data-prefill.preview.emergentagent.com/keyboard-shortcuts.html
```
...
**Individual Files:**
- Chrome Extension: `https://data-prefill.preview.emergentagent.com/canva-scanner-TRADE-SMART.zip`
- Canva App (Fixed): `https://data-prefill.preview.emergentagent.com/canva-STAYS-LOADED.js`
- Scanner Guide: `https://data-prefill.preview.emergentagent.com/canva-scanner-guide.html`
- Keyboard Shortcuts: `https://data-prefill.preview.emergentagent.com/keyboard-shortcuts.html`
