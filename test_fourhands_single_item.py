...
async def test_fourhands_scraping():
    ...
    scrape_url = "https://bugsquash-hub.preview.emergentagent.com/api/scrape-product"
...
async def test_add_item_endpoint():
    ...
    projects_url = "https://bugsquash-hub.preview.emergentagent.com/api/projects"
    add_item_url = "https://bugsquash-hub.preview.emergentagent.com/api/add-item"
    fourhands_url = "https://fourhands.com/product/248606-001"
        ...
        try:
            async with session.get(projects_url) as response:
                ...
                if not projects_result or len(projects_result) == 0:
                    ...
                    create_project_url = "https://bugsquash-hub.preview.emergentagent.com/api/projects"
                    project_data = {
