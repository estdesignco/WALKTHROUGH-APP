  ...
  async executeAction(action) {
    ...
    switch (type) {
      case 'CREATE_INSTALLED':
        return fetch(`https://roomflow-8.preview.emergentagent.com/api/items`, {
          method: 'POST',
      ...
      case 'UPDATE_INSTALLED':
        return fetch(`https://roomflow-8.preview.emergentagent.com/api/items/${data.id}`, {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(data)
        });
      ...
      case 'CREATE_ROOM':
        return fetch(`https://roomflow-8.preview.emergentagent.com/api/rooms`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(data)
        });
