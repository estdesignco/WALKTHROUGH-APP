...
const FFEDashboard = ({ isOffline, hideNavigation = false, projectId: propProjectId }) => {
  ...
  return (
    ...
    >
      ...
      {/* BIG GLOWING FINISH SCHEDULE BUTTON */}
      <button
        onClick={() => {
          const baseUrl = window.location.origin;
          window.location.href = `${baseUrl}/project/${projectId}?tab=Room+Finishes`;
        }}
        className="w-full mb-6 px-6 py-4 rounded-xl text-lg font-black uppercase tracking-widest text-white flex items-center justify-center gap-3"
        style={{
          background: 'linear-gradient(135deg, #D4A574 0%, #B8860B 40%, #D4A574 70%, #B8860B 100%)',
          boxShadow: '0 0 20px rgba(212,165,116,0.6), 0 0 40px rgba(212,165,116,0.3), 0 0 60px rgba(212,165,116,0.15), inset 0 2px 0 rgba(255,255,255,0.25)',
          animation: 'glowPulse 2s ease-in-out infinite',
          textShadow: '0 2px 4px rgba(0,0,0,0.5)',
          border: '2px solid rgba(255,255,255,0.2)'
        }}
        data-testid="ffe-finish-schedule-btn"
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="3" y1="15" x2="21" y2="15"/><line x1="9" y1="3" x2="9" y2="21"/><line x1="15" y1="3" x2="15" y2="21"/></svg>
