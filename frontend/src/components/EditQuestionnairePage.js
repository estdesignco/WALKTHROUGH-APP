                    ...
                    <div className="space-y-8">
                        <section className="border-b-2 border-[#D4A574]/30 pb-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="col-span-2">
                                    ...
                                    <input type="text" value={answers.address || ''} onChange={(e) => handleChange('address', e.target.value)} className={inputClass} placeholder="Enter address" />
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="border-b-2 border-[#D4A574]/30 pb-6">
                            ...
                            <div className="mt-4">
                                ...
                                <textarea value={answers.new_build_address || ''} onChange={(e) => handleChange('new_build_address', e.target.value)} rows={2} className={inputClass} placeholder="Enter address" />
                            </div>
                        </section>
