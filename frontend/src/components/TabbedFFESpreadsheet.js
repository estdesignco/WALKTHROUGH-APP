...
export default function TabbedFFESpreadsheet({ projectId }) {
  ...
  return (
    <div className="w-full h-full flex flex-col" style={{ backgroundColor: '#0F172A' }}>
      ...
      <div className="bg-[#1E293B] p-4 border-b-2 border-[#D4A574]">
        <div className="flex gap-3 flex-wrap">
          <input
            ...
            className="flex-1 px-4 py-2 rounded-lg border-2 border-[#D4A574] text-white focus:outline-none placeholder-[#D4C5A9]/70"
            style={{
      ...
      {project && (
        <div className="bg-[#0F172A] border-b-2 border-[#D4A574]">
          <StatusOverview
