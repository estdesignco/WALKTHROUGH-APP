...
const ActualDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Header - EXACT same as studio page */}
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        {/* Main Action Buttons - EXACTLY as shown in studio page */}
        <div className="flex justify-center gap-6 mb-12">
          <button className="bg-[#C8B898] hover:bg-[#B8A888] text-black px-8 py-3 rounded-full font-medium transition-all duration-300">
            + New Client
          </button>
          
          {/* EMAIL TEMPLATES - with send functionality */}
          <button 
          ...
          <button className="bg-gray-700 hover:bg-gray-600 text-white px-8 py-3 rounded-full font-medium transition-all duration-300">
            + Full Questionnaire
          </button>
        </div>
        ...
        <div className="space-y-6 mb-12">
          {/* Sample project card - same design as your studio page */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <a 
            href="https://studio-project-hub.preview.emergentagent.com/customer/questionnaire" 
            target="_blank" 
          ...
          {/* Email Preview */}
          <a 
            href="https://studio-project-hub.preview.emergentagent.com/email-preview" 
            target="_blank" 
            rel="noopener noreferrer"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <a 
            href="https://luxinterior.preview.emergentagent.com/" 
            target="_blank" 
            rel="noopener noreferrer"
          ...
          <a 
            href="https://designflow-29.preview.emergentagent.com/" 
            target="_blank" 
            rel="noopener noreferrer"
