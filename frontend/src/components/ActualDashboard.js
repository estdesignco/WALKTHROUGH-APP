    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <a 
            href="https://designtoolkit.preview.emergentagent.com/customer/questionnaire" 
            target="_blank" 
          ...
          {/* Email Preview */}
          <a 
            href="https://designtoolkit.preview.emergentagent.com/email-preview" 
            target="_blank" 
            rel="noopener noreferrer"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <a 
            href="https://designtoolkit.preview.emergentagent.com/" 
            target="_blank" 
            rel="noopener noreferrer"
