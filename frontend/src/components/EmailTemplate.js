...
const EmailTemplate = ({ clientName, questionnaireLinkId }) => {
    const questionnaireUrl = `${process.env.REACT_APP_FRONTEND_URL || 'https://studio-project-hub.preview.emergentagent.com'}/customer/questionnaire/${questionnaireLinkId}`;
