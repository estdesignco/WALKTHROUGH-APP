                ...
                <div style={{ textAlign: 'center' }}>
                    ...
                    <p style={{
                        ...
                        Creating extraordinary spaces since 2020
                            ...
                            {/* Personal Greeting */}
                            <tr>
                                <td style={{ padding: '50px 40px 30px 40px', textAlign: 'center' }}>
                                    <h2 style={{
                                        fontSize: '32px',
                                        fontWeight: '300',
                                        color: '#B49B7E',
                            ...
                            <tr>
                                <td style={{ padding: '0 40px 40px 40px' }}>
                                    <div style={{
                                        ...
                                        borderRadius: '15px',
                                        padding: '40px',
                                        border: '1px solid rgba(180, 155, 126, 0.1)'
                                    }}>
                                        <p style={{
                                            fontSize: '16px',
                                            lineHeight: '1.7',
                                        ...
                                        <p style={{
                                            ...
                                            This personalized assessment takes approximately <strong style={{ color: '#B49B7E' }}>10-15 minutes</strong> and covers everything from your design preferences to your family's daily routines. Every detail matters when creating spaces that enhance your life.
                                        </p>
                                        ...
                                        <div style={{ margin: '30px 0' }}>
                                            <div style={{
                                                ...
                                                <div style={{
                                                    width: '8px',
                                                    height: '8px',
                                                    backgroundColor: '#B49B7E',
                                                    borderRadius: '50%',
                                                    marginRight: '15px'
                                                }}></div>
                                                <span style={{ color: '#D0D0D0', fontSize: '15px' }}>Completely confidential and secure</span>
                                            </div>
                                            <div style={{
                                                display: 'flex',
                                                alignItems: 'center',
                                                ...
                                                <span style={{ color: '#D0D0D0', fontSize: '15px' }}>Save and continue at your convenience</span>
                                            </div>
                                            <div style={{
                                                display: 'flex',
                                                alignItems: 'center',
                                                ...
                                                <span style={{ color: '#D0D0D0', fontSize: '15px' }}>No obligation for our initial consultation</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            {/* Call to Action */}
                            <tr>
                                <td style={{ padding: '0 40px 50px 40px', textAlign: 'center' }}>
                                    <a href={questionnaireUrl} style={{
                                        display: 'inline-block',
                                        backgroundColor: '#B49B7E',
                                        background: 'linear-gradient(135deg, #B49B7E 0%, #A08B6F 100%)',
                                        ...
                                        letterSpacing: '1px',
                                        textTransform: 'uppercase',
                                        boxShadow: '0 8px 25px rgba(180, 155, 126, 0.3)',
                            ...
                            <tr>
                                <td style={{
                                    backgroundColor: 'rgba(180, 155, 126, 0.08)',
                                    padding: '40px',
                                    textAlign: 'center',
                                    borderTop: '1px solid rgba(180, 155, 126, 0.1)'
                                }}>
                                    <p style={{
                                        fontSize: '18px',
                                        fontStyle: 'italic',
                            ...
                            <tr>
                                <td style={{
                                    ...
                                    <p style={{
                                        ...
                                        If you no longer wish to receive these emails, you can <a href="#" style={{ color: '#B49B7E' }}>unsubscribe here</a>
                                    </p>
                                </td>
                            </tr>
                        </table>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="600" style="background-color: #1A1A1A; border-radius: 20px; overflow: hidden; box-shadow: 0 20px 40px rgba(180, 155, 126, 0.1);">
                        ...
                        <tr>
                            <td style="background: linear-gradient(135deg, #B49B7E 0%, #A08B6F 50%, #8B7355 100%); padding: 60px 40px; text-align: center;">
                                ...
                                <h1 style="font-family: 'Playfair Display', Georgia, serif; font-size: 42px; font-weight: 300; letter-spacing: 8px; color: white; margin: 0 0 10px 0; text-shadow: 0 2px 4px rgba(0,0,0,0.3);">ESTABLISHED</h1>
                                <div style="font-size: 18px; font-weight: 200; letter-spacing: 4px; color: rgba(255, 255, 255, 0.9); margin: 0 0 30px 0;">DESIGN CO.</div>
