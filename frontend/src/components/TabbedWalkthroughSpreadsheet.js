...
export default function TabbedWalkthroughSpreadsheet({ projectId, sheetType = 'walkthrough' }) {
  ...
  useEffect(() => {
    if (project?.rooms) {
      ...
      console.log('✅ Auto-expanded all categories:', Object.keys(allExpanded).length);
    }
  }, [project?.rooms]);
                      ...
                      <table className="w-full border-collapse border border-[#B49B7E] mb-4 mt-2 shadow-lg shadow-[#B49B7E]/10">
                        <thead>
                          ...
                          <tr>
                            ...
                            <th colSpan="4" className="border border-[#D4A574] px-2 py-1 text-xs font-bold text-white text-center" style={{ 
