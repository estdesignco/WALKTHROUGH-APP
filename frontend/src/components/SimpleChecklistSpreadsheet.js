        ...
        <div className="flex flex-col lg:flex-row gap-4 items-center">
          ...
          <div className="flex-1">
            <input
              ...
              className="w-full px-4 py-2 rounded bg-gray-700 text-[#F5F5DC] border border-gray-600 focus:border-blue-500 focus:outline-none"
            />
          </div>
                            ...
                            <table className="w-full border-collapse border border-[#B49B7E] mb-4 shadow-lg shadow-[#B49B7E]/10">
                              <thead>
                                <tr>
                                  ...
                                  <th className="border border-[#B49B7E] px-2 py-2 text-xs font-bold text-white w-16 shadow-inner shadow-[#B49B7E]/20" style={{ backgroundColor: '#8B4444' }}>QTY</th>
                                  <th className="border border-[#B49B7E] px-2 py-2 text-xs font-bold text-white shadow-inner shadow-[#B49B7E]/20" style={{ backgroundColor: '#8B4444' }}>SIZE</th>
                                  ...
                                  <th className="border border-[#B49B7E] px-2 py-2 text-xs font-bold text-white shadow-inner shadow-[#B49B7E]/20" style={{ backgroundColor: '#8B4444' }}>REMARKS</th>
                                  <th className="border border-[#B49B7E] px-2 py-2 text-xs font-bold text-white w-12 shadow-inner shadow-[#B49B7E]/20" style={{ backgroundColor: '#8B4444' }}>DELETE</th>
                                </tr>
                              </thead>
                              <tbody>
                                ...
                                {subcategory.items?.map((item, itemIndex) => (
                                  ...
                                  {/* QTY - EDITABLE */}
                                  <td className="border border-[#B49B7E] px-2 py-1 text-white text-sm text-center">
                                    <div 
                                      contentEditable={true}
                                      suppressContentEditableWarning={true}
