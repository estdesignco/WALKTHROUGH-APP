  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
        <a 
          href="https://designflow-hub.preview.emergentagent.com/studio" 
          target="_blank" 
          rel="noopener noreferrer"
        ...
        <a 
          href="https://designflow-hub.preview.emergentagent.com/project/a332f2fb-a248-41db-9c50-f028430a6261/detail" 
          target="_blank" 
          rel="noopener noreferrer"
