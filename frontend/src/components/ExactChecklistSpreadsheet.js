                  ...
                  {(provided) => (
                    ...
                    {isCategoryExpanded && (
                      <>
                        ...
                        <table className="border-collapse border border-[#B49B7E] mb-4 shadow-lg shadow-[#B49B7E]/10" style={{ minWidth: '1400px', width: '100%' }} data-category={category.name} data-needs-placement={needsPlacement}>
                          <thead>
                            <tr>
