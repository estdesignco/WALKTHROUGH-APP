                      ...
                      <>
                        ...
                        <div className="mb-4 flex gap-3 flex-wrap">
                          <button
                            onClick={() => {
                              ...
                              modal.innerHTML = `
                                <div style="background: linear-gradient(135deg, #000 0%, #1e293b 50%, #000 100%); padding: 40px; border-radius: 16px; max-width: 600px; border: 3px solid #D4A574;">
                                  <h2 style="color: #D4A574; font-size: 24px; margin-bottom: 20px; text-align: center;">🎨 Connect to Canva</h2>
                                  
                                  <div style="background: rgba(30, 41, 59, 0.8); padding: 20px; border-radius: 12px; margin-bottom: 20px; border: 2px solid #B49B7E;">
                                    <p style="color: #B49B7E; margin-bottom: 10px; font-size: 14px;"><strong>Room:</strong> ${room.name}</p>
                                  ...
                                  <div style="background: rgba(139, 68, 68, 0.3); padding: 16px; border-radius: 8px; margin-bottom: 20px; border-left: 4px solid #D4A574;">
                                    <p style="color: #D4C5A9; font-size: 13px; line-height: 1.6;">
                                      ...
                                      1. Open Canva.com in another tab<br>
                                      2. Open any design<br>
                                      3. Click your "Live Checklist" app from left sidebar<br>
                                      4. Copy/paste the Project ID above<br>
                                      5. Copy/paste the Room ID above<br>
                                      6. Click "Load Checklist"
                                    </p>
                                  </div>
                            ...
                            title="Get connection info for Canva"
                          >
                            🎨 CONNECT TO CANVA
                          </button>
