                                ...
                                {subcategory.items?.map((item, itemIndex) => (
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <option value="TO BE SELECTED" style={{ background: 'linear-gradient(135deg, #64748BFF 0%, #64748BAA 50%, #64748BFF 100%)', color: 'white' }}>⚪ TO BE SELECTED</option>
                                      ...
                                      <option value="ORDERED" style={{ background: 'linear-gradient(135deg, #14B8A6FF 0%, #14B8A6AA 50%, #14B8A6FF 100%)', color: 'white' }}>🟩 ORDERED</option>
                                      ...
                                      <option value="CONFIRMED" style={{ background: 'linear-gradient(135deg, #22C55EFF 0%, #22C55EAA 50%, #22C55EFF 100%)', color: 'white' }}>✅ CONFIRMED</option>
                                      ...
                                      <option value="IN TRANSIT" style={{ background: 'linear-gradient(135deg, #6366F1FF 0%, #6366F1AA 50%, #6366F1FF 100%)', color: 'white' }}>🚚 IN TRANSIT</option>
                                      <option value="OUT FOR DELIVERY" style={{ background: 'linear-gradient(135deg, #2563EBFF 0%, #2563EBAA 50%, #2563EBFF 100%)', color: 'white' }}>📦 OUT FOR DELIVERY</option>
                                      ...
                                      <option value="DELIVERED TO JOB SITE" style={{ background: 'linear-gradient(135deg, #A855F7FF 0%, #A855F7AA 50%, #A855F7FF 100%)', color: 'white' }}>💜 DELIVERED TO JOB SITE</option>
                                      <option value="RECEIVED" style={{ background: 'linear-gradient(135deg, #9333EAFF 0%, #9333EAAA 50%, #9333EAFF 100%)', color: 'white' }}>📥 RECEIVED</option>
                                      <option value="READY FOR INSTALL" style={{ background: 'linear-gradient(135deg, #059669FF 0%, #059669AA 50%, #059669FF 100%)', color: 'white' }}>🔧 READY FOR INSTALL</option>
                                      <option value="INSTALLING" style={{ background: 'linear-gradient(135deg, #16A34AFF 0%, #16A34AAA 50%, #16A34AFF 100%)', color: 'white' }}>🛠️ INSTALLING</option>
                                      ...
                                      <option value="ON HOLD" style={{ background: 'linear-gradient(135deg, #DC2626FF 0%, #DC2626AA 50%, #DC2626FF 100%)', color: 'white' }}>⏸️ ON HOLD</option>
                                      <option value="BACKORDERED" style={{ background: 'linear-gradient(135deg, #B91C1CFF 0%, #B91C1CAA 50%, #B91C1CFF 100%)', color: 'white' }}>⏳ BACKORDERED</option>
                                      ...
                                      <option value="RETURNED" style={{ background: 'linear-gradient(135deg, #BE123CFF 0%, #BE123CAA 50%, #BE123CFF 100%)', color: 'white' }}>↩️ RETURNED</option>
                                      <option value="CANCELLED" style={{ background: 'linear-gradient(135deg, #7F1D1DFF 0%, #7F1D1DAA 50%, #7F1D1DFF 100%)', color: 'white' }}>❌ CANCELLED</option>
                                    </select>
                                  </td>
