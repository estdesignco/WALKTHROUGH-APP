...
import { Loader2, PlusCircle, XCircle, Home, Calendar } from 'lucide-react';
                ...
                {showBooking && submissionStatus === 'success' ? (
                    ...
                    <Section title="TYPE OF PROJECT" description="Tell us more about your project and what you would love to accomplish, and how we can best partner with you!">
                        ...
                        {formData.project_type === 'Other' && (
                            <FieldWrapper label="Tell us about your project">
                                <textarea id="other_project_description" className={textareaStyles} value={formData.other_project_description || ''} onChange={(e) => handleFormChange('other_project_description', e.target.value)} placeholder="Please describe your project..."></textarea>
                            </FieldWrapper>
                        )}
                    </Section>
                    ...
                    {formData.project_type === 'New Build' && (
                        <Section title="NEW BUILD" description="If you are not currently building a new home, please feel free to skip these questions!">
                            ...
                            <FieldWrapper label="Once home is complete, will you be needing furniture? If so, give us an idea of what items you would love to procure!">
                                <textarea id="new_build_need_furniture" className={textareaStyles} value={formData.new_build_need_furniture || ''} onChange={(e) => handleFormChange('new_build_need_furniture', e.target.value)}></textarea>
                            </FieldWrapper>
                            <FieldWrapper label="Is there anything else we need to know about the scope of this project?">
                                <textarea id="new_build_scope_notes" className={textareaStyles} value={formData.new_build_scope_notes || ''} onChange={(e) => handleFormChange('new_build_scope_notes', e.target.value)}></textarea>
                            </FieldWrapper>
                        </Section>
                    )}
                        ...
                        <Section title="RENOVATION" description="If you are not looking to renovate, please feel free to skip these questions!">
                            <FieldWrapper label="Please list Renovation Address (If different!)">
                                <GoogleAddressInput
                                    ...
                                    onChange={(val) => handleFormChange('renovation_address', val)}
                                    className={inputStyles}
                                    placeholder="Start typing address..."
                                    style={{ minHeight: '60px' }}
                                />
                            ...
                            <FieldWrapper label="Do you have a Builder?">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        <label className="text-sm text-[#B49B7E]">Builder Name</label>
                                        <input className="flex h-12 w-full rounded-md border border-gray-600 bg-gray-700 px-4 py-2 text-[#F5F5DC] focus:outline-none focus:ring-2 focus:ring-[#8B7355] placeholder:text-stone-400" placeholder="Enter builder name" value={formData.renovation_builder || ''} onChange={(e) => handleFormChange('renovation_builder', e.target.value)} />
                                    </div>
                                    <div className="space-y-1">
                                        <label className="text-sm text-[#B49B7E]">Builder Phone</label>
                            ...
                            <FieldWrapper label="Do you have an Architect?">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        <label className="text-sm text-[#B49B7E]">Architect Name</label>
                                        <input className="flex h-12 w-full rounded-md border border-gray-600 bg-gray-700 px-4 py-2 text-[#F5F5DC] focus:outline-none focus:ring-2 focus:ring-[#8B7355] placeholder:text-stone-400" placeholder="Enter architect name" value={formData.renovation_architect || ''} onChange={(e) => handleFormChange('renovation_architect', e.target.value)} />
                                    </div>
                                    <div className="space-y-1">
                                        <label className="text-sm text-[#B49B7E]">Architect Phone</label>
                            ...
                            <FieldWrapper label="Briefly describe the existing condition of the space.">
                                <textarea id="renovation_existing_condition" className={textareaStyles} value={formData.renovation_existing_condition || ''} onChange={(e) => handleFormChange('renovation_existing_condition', e.target.value)}></textarea>
                            </FieldWrapper>
                            <FieldWrapper label="Once home is complete, will you be needing furniture? If so, give us an idea of what items you would love to procure!">
                                <textarea id="renovation_need_furniture" className={textareaStyles} value={formData.renovation_need_furniture || ''} onChange={(e) => handleFormChange('renovation_need_furniture', e.target.value)}></textarea>
                            </FieldWrapper>
                            <FieldWrapper label="Are there any physical MEMORIES in this home that you would like to preserve?">
                                <textarea id="renovation_memories" className={textareaStyles} value={formData.renovation_memories || ''} onChange={(e) => handleFormChange('renovation_memories', e.target.value)}></textarea>
                            </FieldWrapper>
                            <FieldWrapper label="Is there anything else we need to know about the scope of this project?">
                                <textarea id="renovation_scope_notes" className={textareaStyles} value={formData.renovation_scope_notes || ''} onChange={(e) => handleFormChange('renovation_scope_notes', e.target.value)}></textarea>
                            </FieldWrapper>
                        </Section>
                    )}
                    ...
                    {formData.project_type === 'Furniture/Styling Refresh' && (
                        <Section title="FURNITURE REFRESH" description="If you are not looking for a furniture refresh, please feel free to skip these questions!">
                            <FieldWrapper label="Briefly describe the existing condition of the space.">
                                <textarea id="furniture_refresh_condition" className={textareaStyles} value={formData.furniture_refresh_condition || ''} onChange={(e) => handleFormChange('furniture_refresh_condition', e.target.value)}></textarea>
                            </FieldWrapper>
                            ...
                            <FieldWrapper label="Is there anything else we need to know about the scope of this project?">
                                <textarea id="furniture_scope_notes" className={textareaStyles} value={formData.furniture_scope_notes || ''} onChange={(e) => handleFormChange('furniture_scope_notes', e.target.value)}></textarea>
                            </FieldWrapper>
                        </Section>
                    )}
                    ...
                    <Section title="DESIGN QUESTIONS">
                        <FieldWrapper label="What do you love about your current home?">
                            <textarea id="design_love_home" className={textareaStyles} value={formData.design_love_home || ''} onChange={(e) => handleFormChange('design_love_home', e.target.value)}></textarea>
                        </FieldWrapper>
                        ...
                        <FieldWrapper label="What is the first impression you want guests to have when they enter your home?">
                            <textarea id="design_first_impression" className={textareaStyles} value={formData.design_first_impression || ''} onChange={(e) => handleFormChange('design_first_impression', e.target.value)}></textarea>
                        </FieldWrapper>
                        <FieldWrapper label="Is there a common color palette in your home that you love?">
                            <textarea id="design_common_color_palette" className={textareaStyles} value={formData.design_common_color_palette || ''} onChange={(e) => handleFormChange('design_common_color_palette', e.target.value)}></textarea>
                        </FieldWrapper>
                        ...
                        <FieldWrapper label="Are there any colors do you dislike?">
                            <textarea id="design_disliked_colors" className={textareaStyles} value={formData.design_disliked_colors || ''} onChange={(e) => handleFormChange('design_disliked_colors', e.target.value)}></textarea>
                        </FieldWrapper>
                        ...
                        <FieldWrapper label="What do you like about these styles?">
                            <textarea id="design_styles_love" className={textareaStyles} value={formData.design_styles_love || ''} onChange={(e) => handleFormChange('design_styles_love', e.target.value)}></textarea>
                        </FieldWrapper>
                        ...
                        <FieldWrapper label="Is there a piece of art, furniture, or a souvenir that holds significant personal meaning to you? Tell us the story behind it.">
                            <textarea id="design_meaningful_item" className={textareaStyles} value={formData.design_meaningful_item || ''} onChange={(e) => handleFormChange('design_meaningful_item', e.target.value)}></textarea>
                        </FieldWrapper>
                        <FieldWrapper label="Are there any existing furniture pieces or decor items you'd like to keep in the space? If so, please let us know the measurements and attach a photo below for reference.">
                            <textarea id="design_existing_furniture" className={textareaStyles} value={formData.design_existing_furniture || ''} onChange={(e) => handleFormChange('design_existing_furniture', e.target.value)}></textarea>
                        </FieldWrapper>
                        ...
                        <FieldWrapper label="Do you have any specific materials you prefer or want to avoid?">
                            <textarea id="design_materials_to_avoid" className={textareaStyles} value={formData.design_materials_to_avoid || ''} onChange={(e) => handleFormChange('design_materials_to_avoid', e.target.value)}></textarea>
                        </FieldWrapper>
                        <FieldWrapper label="Do you have any special requirements or considerations? (e.g., accessibility needs, allergies, etc.)">
                            <textarea id="design_special_requirements" className={textareaStyles} value={formData.design_special_requirements || ''} onChange={(e) => handleFormChange('design_special_requirements', e.target.value)}></textarea>
                        </FieldWrapper>
                        ...
                        <FieldWrapper label="Do you have a Houzz or Pinterest page? Please list your accounts below, and you can also invite us to your boards.">
                            <div className="space-y-2">
                                ...
                                <textarea id="design_pinterest_houzz" className={textareaStyles} value={formData.design_pinterest_houzz || ''} onChange={(e) => handleFormChange('design_pinterest_houzz', e.target.value)}></textarea>
                            </div>
                        </FieldWrapper>
                        <FieldWrapper label="Any additional comments or questions?">
                            <textarea id="design_additional_comments" className={textareaStyles} value={formData.design_additional_comments || ''} onChange={(e) => handleFormChange('design_additional_comments', e.target.value)}></textarea>
                        </FieldWrapper>
                    </Section>
                    ...
                    <Section title="GETTING TO KNOW YOU BETTER..." description="We want to get to know you better so we can serve you in the best way possible! We not only want to help design your home, but want your experience with us to be tailor-made JUST FOR YOU!">
                        <FieldWrapper label="Who lives in your household? (Include ages of children if applicable)">
                            <textarea id="know_you_household" className={textareaStyles} value={formData.know_you_household || ''} onChange={(e) => handleFormChange('know_you_household', e.target.value)}></textarea>
                        </FieldWrapper>
                        <FieldWrapper label="Do you have pets? If yes, please specify">
                            <textarea id="know_you_pets" className={textareaStyles} value={formData.know_you_pets || ''} onChange={(e) => handleFormChange('know_you_pets', e.target.value)}></textarea>
                        </FieldWrapper>
                        <FieldWrapper label="Describe a typical weekday for your household. What activities take place in the home?">
                            <textarea id="know_you_weekday_routine" className={textareaStyles} value={formData.know_you_weekday_routine || ''} onChange={(e) => handleFormChange('know_you_weekday_routine', e.target.value)}></textarea>
                        </FieldWrapper>
                        <FieldWrapper label="Describe a typical weekend for your household.">
                            <textarea id="know_you_weekend_routine" className={textareaStyles} value={formData.know_you_weekend_routine || ''} onChange={(e) => handleFormChange('know_you_weekend_routine', e.target.value)}></textarea>
                        </FieldWrapper>
                        <FieldWrapper label="Are you early birds or night owls? How does natural and artificial lighting play a role in your daily routines?">
                            <textarea id="know_you_lighting_preference" className={textareaStyles} value={formData.know_you_lighting_preference || ''} onChange={(e) => handleFormChange('know_you_lighting_preference', e.target.value)}></textarea>
                        </FieldWrapper>
                        <FieldWrapper label="How do you typically entertain guests? (e.g., large formal dinners, casual get-togethers, intimate cocktails, kids' parties)">
                            <textarea id="know_you_entertaining_style" className={textareaStyles} value={formData.know_you_entertaining_style || ''} onChange={(e) => handleFormChange('know_you_entertaining_style', e.target.value)}></textarea>
                        </FieldWrapper>
                        <FieldWrapper label="Where does each family member go to relax and have personal time? What activities do they do there?">
                            <textarea id="know_you_relax_space" className={textareaStyles} value={formData.know_you_relax_space || ''} onChange={(e) => handleFormChange('know_you_relax_space', e.target.value)}></textarea>
                        </FieldWrapper>
                        <FieldWrapper label="How do you see your family's needs changing in the next 5-10 years? (e.g., growing children, aging in place, working from home more)">
                            <textarea id="know_you_future_plans" className={textareaStyles} value={formData.know_you_future_plans || ''} onChange={(e) => handleFormChange('know_you_future_plans', e.target.value)}></textarea>
                        </FieldWrapper>
                        ...
                        <FieldWrapper label="Tell us about your hobbies">
                            <div className="space-y-2">
                                ...
                                <textarea id="know_you_hobbies" className={textareaStyles} value={formData.know_you_hobbies || ''} onChange={(e) => handleFormChange('know_you_hobbies', e.target.value)}></textarea>
                            </div>
                        </FieldWrapper>
                        <FieldWrapper label="What do you you like to do for fun?">
                            <textarea id="know_you_fun" className={textareaStyles} value={formData.know_you_fun || ''} onChange={(e) => handleFormChange('know_you_fun', e.target.value)}></textarea>
                        </FieldWrapper>
                        ...
                        <FieldWrapper label="What does your Family like to do together for fun?">
                            <textarea id="know_you_family_together" className={textareaStyles} value={formData.know_you_family_together || ''} onChange={(e) => handleFormChange('know_you_family_together', e.target.value)}></textarea>
                        </FieldWrapper>
                        ...
                        <FieldWrapper label="What is your favorite place to vacation?">
                            <textarea id="know_you_favorite_vacation" className={textareaStyles} value={formData.know_you_favorite_vacation || ''} onChange={(e) => handleFormChange('know_you_favorite_vacation', e.target.value)}></textarea>
                        </FieldWrapper>
                        <FieldWrapper label="Tell us about your favorite foods, snacks, drinks, wine, beer, etc... OR ANYTHING ELSE that you just LOVE that we should know about!">
                            <textarea id="know_you_favorite_foods" className={textareaStyles} value={formData.know_you_favorite_foods || ''} onChange={(e) => handleFormChange('know_you_favorite_foods', e.target.value)}></textarea>
                        </FieldWrapper>
                        <FieldWrapper label="When you come home after a long day, what space do you naturally gravitate toward, and what feeling do you want that space to evoke?">
                            <textarea id="know_you_evoke_space" className={textareaStyles} value={formData.know_you_evoke_space || ''} onChange={(e) => handleFormChange('know_you_evoke_space', e.target.value)}></textarea>
                        </FieldWrapper>
                        <FieldWrapper label="How do you want your home to support your social life?">
                            <textarea id="know_you_support_social_life" className={textareaStyles} value={formData.know_you_support_social_life || ''} onChange={(e) => handleFormChange('know_you_support_social_life', e.target.value)}></textarea>
                        </FieldWrapper>
                        <FieldWrapper label="Is there ANYTHING ELSE that you would like to share with us to let us know how we can best serve you such as favorite memories of your last or current home, or favorite places, or just ANYTHING you want to share with us we would LOVE to to know about it as we get to know each other better!">
                            <textarea id="know_you_share_more" className={textareaStyles} value={formData.know_you_share_more || ''} onChange={(e) => handleFormChange('know_you_share_more', e.target.value)}></textarea>
                        </FieldWrapper>
                    </Section>
