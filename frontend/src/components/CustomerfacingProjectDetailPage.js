...
export default function ProjectPage() {
    ...
    const tabs = [
        { name: "Questionnaire", icon: FileQuestion, component: project ? <EditableQuestionnaireTab project={project} onUpdate={fetchProject} /> : <div className="text-center text-stone-300 py-8">Loading questionnaire...</div> },
