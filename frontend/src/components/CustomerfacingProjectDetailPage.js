                ...
                <div className="bg-stone-800 rounded-lg border border-stone-700 p-6">
                    ...
                    {project.project_type === "New Build" && (
                        <div className="space-y-4">
                            ...
                            {project.new_build_architect_additional_contacts && (
                                <div>
                                    <label className="block text-sm font-medium text-stone-300 mb-2">Additional Architect Contacts</label>
                                    <div className="p-3 bg-stone-700 border border-stone-600 rounded text-stone-200">
                                        {Array.isArray(project.new_build_architect_additional_contacts) 
                                            ? project.new_build_architect_additional_contacts.join(', ')
                                            : project.new_build_architect_additional_contacts}
                                    </div>
                                </div>
                            )}
                            {project.new_build_builder_additional_contacts && (
                                <div>
                                    <label className="block text-sm font-medium text-stone-300 mb-2">Additional Builder Contacts</label>
                                    <div className="p-3 bg-stone-700 border border-stone-600 rounded text-stone-200">
                                        {Array.isArray(project.new_build_builder_additional_contacts) 
                                            ? project.new_build_builder_additional_contacts.join(', ')
                                            : project.new_build_builder_additional_contacts}
                                    </div>
                                </div>
                            )}
